...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern=""):
    ...
    if utterance == "把市政做好，":
        if CHATBOT_MODE:
            ...
            resultDICT["action"] = "做好"
            pass

    if utterance == "把手中的呆帳打完":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            resultDICT["action"] = "打完"
            pass
